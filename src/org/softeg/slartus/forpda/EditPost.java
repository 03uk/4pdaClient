...
public class EditPost {
    ...
    public static String getPostForm(Boolean enableSig, Boolean enableemo, String msg, Boolean isModerator, Boolean loadImages) {
        ...
        return "<div class=\"quick_editor\">" +
                ...
                "<form name=\"f1\" action=\"\" method=\"post\" enctype=\"multipart/form-data\"><table border=0 align=\"center\" class=\"post_table\">\n" +
                " <tr><td>\n"
                +getBBCodesLine(theme,loadImages)
...
//                "  </script>" +
    ...
    private static String getBBCodesLine(String theme,Boolean loadImages) {
        
        String[] bbtags = {"B","I","U","S","SUB","SUP","LEFT","CENTER","RIGHT","QUOTE","OFFTOP","CODE","SPOILER","HIDE",};
        StringBuilder sb = new StringBuilder();
        int i = 0;
        for (String bbtag : bbtags) {
            if(loadImages)
                sb.append("<img src=\"file:///android_asset/forum/style_images/1/folder_editor_buttons_"
                    + theme + "/" + bbtag.toLowerCase() + ".png\" width=\"20\" height=\"20\" hspace=\"0\" vspace=\"0\"  onClick=\"bbstyle(" + i + ")\" />\n");
            else
                sb.append("<input  class=\"href_button\" type=\"button\" value=\""+bbtag+"\" hspace=\"0\" vspace=\"0\" onClick=\"bbstyle(" + i + ")\" />\n");
            i+=2;
        }
        return sb.toString();
    }
