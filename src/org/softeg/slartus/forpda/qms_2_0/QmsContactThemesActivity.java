...
public class QmsContactThemesActivity extends BaseFragmentActivity implements AdapterView.OnItemClickListener,
    ...
    public static void showThemes(Activity activity, String mid, String userNick) {
...
//        m_ListFooter.setVisibility(m_Mails.size() > 0 ? View.VISIBLE : View.GONE);
    ...
    private static class QmsUsersLoader extends AsyncTaskLoader<QmsUserThemes> {
        ...
        public QmsUserThemes loadInBackground() {
            try {
                ...
                QmsUserThemes mails = Qms_2_0.getQmsUserThemes(Client.INSTANCE, m_Id, qmsUsers,
                        m_ParseNick);
                Client.INSTANCE.setQms_2_0_Count(qmsUsers.unreadMessageUsersCount());
    ...
    public class QmsContactsAdapter extends ArrayAdapter<QmsUserTheme> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.txtNick.setText(user.Title);
    ...
    private class DeleteTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            try {
                ...
                Qms_2_0.deleteDialogs(Client.INSTANCE, m_Id, m_Ids);
    ...
    private final class AnActionModeOfEpicProportions implements ActionMode.Callback {
        ...
        public boolean onActionItemClicked(final ActionMode mode, MenuItem item) {
            if (m_QmsUsers.getSelectedCount() != 0)
                new AlertDialog.Builder(QmsContactThemesActivity.this)
    ...
    public static final class MenuFragment extends SherlockFragment {
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
            MenuItem item = menu.add("Новая тема").setIcon(android.R.drawable.ic_menu_send);
            ...
            item = menu.add("Удалить диалоги").setIcon(android.R.drawable.ic_menu_delete);
            item.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                public boolean onMenuItemClick(MenuItem menuItem) {
